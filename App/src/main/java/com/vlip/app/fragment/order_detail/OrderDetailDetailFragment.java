...
public class OrderDetailDetailFragment extends BaseFragment<OrderDetailPresenter> implements OrderDetailView {
...
//        mViewPager.setCurrentItem(item, false);
    ...
    public OrderDetailPresenter createPresenter() {
        return new OrderDetailPresenter(new OrderModel2(), this);
    }
